        ...
        derivs u)
{
  ...
  //SB: Set sources = 0. , switch off code below that does not make sense.
#if (0)
  if (use_sources)
  {
    double *s_x, *s_y, *s_z;
...
double
PunctEvalAtArbitPosition (double *v, int ivar, double A, double B, double phi,
